                    ...
                    <div class="inner panel-group margin-btm40" id="accordion">
						...
						<div class="panel">
                            ...
                            <div id="collapse1" class="panel-collapse collapse ">
                                <div class="panel-body">
									<center>
									<button type="button" onclick="geolocation()" class="btn btn-primary" style="width:100%;">Posisi Sekarang <i class="fa fa-location-arrow"></i></button>
									<br><button type="button" onclick="tambahlokasi()" class="btn btn-primary" style="width:100%;">Posisi Manual <i class="fa fa-map-marker"></i></button>
									</center>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapse2" class="panel-collapse collapse ">
                                <div class="panel-body">
                                    <div class="input-group">
                                        <label class="sr-only" for="subscribe-email">cari</label>
						...
						<div class="panel">
                            ...
                            <div id="collapse6" class="panel-collapse collapse">
                                <div class="panel-body">
									<select required name="selectken" id="selectken" style="margin-bottom:5px;" class="form-control" placeholder="Pilih Jurusan">
										<option value="">--Pilih Kendaraan--</option>
									</select>
									<select required name="selectbeng" id="selectbeng" class="form-control" placeholder="Pilih Jurusan">
										<option value="">--Pilih Bengkel--</option>
									</select>
									<button type="submit" id="buttonkat" style="" class="btn btn-primary" onclick=""> Cari <i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
						<div class="panel">
                            ...
                            <div id="collapse4" class="panel-collapse collapse">
                                <div class="panel-body">
									...
									<button type="submit" id="buttoncarikec" style="" class="btn btn-primary" onclick=""> Cari <i class="fa fa-search"></i></button>
						...
						<div class="panel">
                            ...
                            <div id="collapse5" class="panel-collapse collapse">
                                <div class="panel-body">
									...
									<button type="submit" id="buttonlayanan" style="" class="btn btn-primary" onclick=""> Cari <i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
