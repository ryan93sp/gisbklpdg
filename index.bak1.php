...
AIzaSyDM2fDXHmGzCDmDBk3bdPIEjs6zwnI1kGQ&signed_in=true"></script>
            ...
            <div style="" class="map-canvas list-width-20 results-collapsed" id="sidebar">
				...
				<div class="items-list" style="width:25%;" id="hasil">
                    <div class="inner" id="innerbtn">
						...
						<div id="list-a" style="display:block;">
							<!--<div class="list-det" id="1" onclick='showdetail(this.id);'>
								<a href="#">
								<div class="nama">Andalas Bengkel id1</div>
								<div>jl andalas motor</div>
								<div>08121212121</div>
								<p style="color:Blue;">Buka</p>
								</a>
							</div>
							<div class="list-det" id="2" onclick='showdetail(this.id);'>
								<a href="#">
								<div class="nama">Bengkel Motor id2</div>
								<div>jl andalas</div>
								<div>08121212121</div>
