...
while($row = pg_fetch_array($hasil)){
	...
	$longitude=$row['lng'];
	$latitude=$row['lat'];
	$dataarray[]=array('gid'=>$gid,'nama_bengkel'=>$nama,'alamat'=>$alamat,'telpon'=>$telpon,'hari'=>$hari,'foto'=>$foto,'kendaraan'=>$kendaraan,'jenis'=>$jenis,'deskripsi'=>$deskripsi,'jam_buka'=>$jam_buka,'jam_tutup'=>$jam_tutup,'longitude'=>$longitude,'latitude'=>$latitude);
}
